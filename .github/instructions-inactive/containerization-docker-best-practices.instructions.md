...
description: "Rules for writing Dockerfiles and docker-compose files: multi-stage builds, layer optimization, security hardening, non-root users, .dockerignore, health checks, and image scanning."
---
