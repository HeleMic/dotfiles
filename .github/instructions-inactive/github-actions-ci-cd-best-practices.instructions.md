...
description: "Rules for writing GitHub Actions workflows: job structure, secret management, dependency caching, matrix strategies, reusable workflows, security hardening, and deployment patterns."
---
